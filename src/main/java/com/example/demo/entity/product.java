...
@NamedNativeQuery(
        name = "findAllProductByPriceAscending",
        resultSetMapping = "product",
        query = "select * from product s order by s.product_price ASC"
)

@NamedNativeQuery(
        name = "findAllProductByPriceDescending",
        resultSetMapping = "product",
        query = "select * from product s order by s.product_price desc"
)
